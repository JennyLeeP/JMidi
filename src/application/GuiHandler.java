...
public class GuiHandler {
    ...
    private Multimap<KeyCode,EnumDirection> keysPressed2 = ArrayListMultimap.create();
	...
	create.setOnAction(e -> {  //TODO Change if's to be in series not nested.
		...
		if (!keybindTA.getText().isEmpty()) { 
		    ...
		    Action.actionMap.put(stringToInt(buttonInput.getText()), new Action(EnumActionType.KEYBIND, Action.keysPressed = keysPressed2));
		    //keysPressed2.clear();
		    dialog.close();
		}else {
